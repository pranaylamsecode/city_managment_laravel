...
>
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="https://pranaylamse.github.io/Portfolio-pranay-lamse/">Pranay Lamse</a>.</strong>
        </footer>
    </div>
    ...
    <link rel="stylesheet" href="https://ntpl.world/front/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="https://ntpl.world/front/assets/css/custom.css">
    <script src="https://ntpl.world/front/assets/js/owl.carousel.js"></script>
</body>
