...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2023 at 11:54 AM
...
(1, 'users', 'users.index', 'View Users', '2023-03-01 11:33:22', '2023-03-01 11:33:22'),
(2, 'users', 'users.create', 'Create New User', '2023-03-01 11:33:22', '2023-03-01 11:33:22'),
(3, 'users', 'users.edit', 'Edit Existing User', '2023-03-01 11:33:22', '2023-03-01 11:33:22'),
(4, 'users', 'users.delete', 'Delete Existing User', '2023-03-01 11:33:22', '2023-03-01 11:33:22');
...
(1, 'admin', 'admin', '2023-03-01 11:33:22', '2023-03-01 11:33:22', NULL),
(2, 'manager', 'manager', '2023-03-01 11:33:22', '2023-03-01 11:33:22', NULL);
...
CREATE TABLE `users` (
  ...
  `number` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `owner_id`, `role_id`, `email`, `email_verified_at`, `password`, `remember_token`, `image`, `city_id`, `number`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 'admin@lte.com', '2023-03-01 11:33:22', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'yKP44L8t4UmQUZWujRlIjNvpT5ZCkt8A3mlWMlwVzujYnV1pmvEm3URzu70Z', 'i2XmUnnrMBn2KV5G5TeyV7j1aOkw4i6VoRbRpHzr.jpg', 333, '2147483647', '2023-03-01 11:33:22', '2023-03-01 11:38:56', NULL),
(2, 1, 2, 'manager@lte.com', '2023-03-01 11:33:23', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'flv7MUInCs', NULL, 333, '+918254516456', '2023-03-01 11:33:23', '2023-03-01 11:33:23', NULL),
(3, 1, 2, 'delores19@example.com', '2023-03-01 11:33:23', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'MpklmqETf4', NULL, 332, '+9184576241', '2023-03-01 11:33:23', '2023-03-01 11:33:23', NULL),
(11, 1, 2, 'holson@example.net', '2023-03-01 11:33:23', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'QdUCQ4gWOx', NULL, 331, '+9184562415', '2023-03-01 11:33:23', '2023-03-01 11:33:23', NULL);
